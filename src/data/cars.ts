...
const CAR_CONFIGS: CarConfig[] = [
    ...
    },
    {
        ...
        descriptionIt: "Il carro armato indistruttibile. Viaggia senza fretta, per sempre.",
        descriptionEn: "The indestructible tank. Travels without haste, forever.",
        extendedDescriptionIt: "La 'Baby Benz' che ha ridefinito gli standard di durata. La W201 190 D non conosce la fretta, ma l'inesorabilità: è probabilmente l'auto meglio costruita della storia. Progettata per durare un milione di chilometri, è un'icona di ingegneria ossessiva.",
        extendedDescriptionEn: "The 'Baby Benz' that redefined durability standards. The W201 190 D knows no haste, only relentlessness: it is arguably the best-built car in history. Designed to last a million kilometers, it is an icon of obsessive engineering.",
        basePrice: 15000,
        baseYear: 2015,
