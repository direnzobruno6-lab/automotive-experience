...
export const ARTICLES: Article[] = [
    ...
    },
    {
        ...
        contentIt: `
            ...
            <p class="mb-6">John Barnard e la McLaren MP4/1 cambiarono tutto in F1 introducendo la monoscocca in fibra di carbonio. Pochi anni dopo, la <strong>Ferrari F40</strong> portò questa tecnologia su strada. Improvvisamente, le auto potevano essere leggere come piume ma rigide come roccia. È stata la fine del metallo pesante e l'inizio dell'era aerospaziale.</p>
        ...
        contentEn: `
            ...
            <p class="mb-6">John Barnard and the McLaren MP4/1 changed everything in F1 by introducing the carbon fiber monocoque. A few years later, the <strong>Ferrari F40</strong> brought this tech to the road. Suddenly, cars could be feather-light yet rock-hard. It was the end of heavy metal and the beginning of the aerospace age.</p>
